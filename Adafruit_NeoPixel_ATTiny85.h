/*--------------------------------------------------------------------
  This file is a modification to the Adafruit NeoPixel Library for use with AVR ATTiny85.
  This file is available under the same licenses as the Adafruit Neopixel Library.

  Contributor : Ankit Daftery
